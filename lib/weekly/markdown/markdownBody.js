...
module.exports = async (context, {
  ...
  body += `*You can also [view all Weekly Digests by clicking here](https://github.com/${owner}/${repo}/issues?q=is:open+is:issue+label:hydrabot-stats).* \n\n`
  body += `> Your **Weekly Digest** brought to you by [**Hydrab0t**](https://github.com/apps/Hydrab0t). :calendar:\n`
  console.log(body)
  return body
}
